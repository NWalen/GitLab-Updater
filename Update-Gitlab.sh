  ...
  if ! sudo dpkg -i "$file" > /dev/null 2>dpkg_error.log; then
    ...
    if [[ -n "$required_minor" ]]; then
      case "$required_minor" in
        ...
        "17.1")  required_minor="17.1.8" ;;
        "17.3")  required_minor="17.3.7" ;;
        "17.5")  required_minor="17.5.2" ;;
        "17.7")  required_minor="17.7.3" ;;
        "17.8")  required_minor="17.8.4" ;;
        "17.11") required_minor="17.11.2" ;;
...
main() {
  ...
  log "🚀 Starting upgrade path from $current → $next"
